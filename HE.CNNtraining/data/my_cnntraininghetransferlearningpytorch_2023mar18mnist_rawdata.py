# -*- coding: utf-8 -*-
"""My_CNNtrainingHEtransferlearningPyTorch_2023Mar18MNIST_RawData.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KTkWXnXdkpi4zgJAmLxNFWW5HJ35tstO
"""
...
with open('Original_MNIST_testdata.csv', 'w') as csvfile:
...
with open('Original_MNIST_traindata.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
