# -*- coding: utf-8 -*-
"""My_CNNtrainingHEtransferlearningPyTorch_2023Mar18USPS_RawData.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vKdA3snEHk8XZi7TWF6b14IMBONTbnf6
"""
...
with open('Original_USPS_testdata.csv', 'w') as csvfile:
...
for X, y in train_dataloader:
    ...
    print(f"Shape of test_dataset: {len(train_dataset)}, {len(train_dataset[0])}")

print("train_dataset :" + str(len(train_dataset)) + ",\t" + str(len(train_dataset[0])) )
print(type(train_dataset))
with open('Original_USPS_traindata.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
