# -*- coding: utf-8 -*-
"""My_CNNtrainingHEtransferlearningPyTorch_2023Mar18CIFAR10_TopLayerOutputData.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rnXaEESZAPv7L2oLe-Tz9YemGmD7KTOE
"""
...
model = models.regnet_y_400mf(pretrained=True)  #regnet_y_400mf(pretrained=True) 
...
with open('REGNET_Y_400MF_CIFAR10_TRAINING.csv', 'w') as csvfile:
...
with open('REGNET_Y_400MF_CIFAR10_TESTING.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
