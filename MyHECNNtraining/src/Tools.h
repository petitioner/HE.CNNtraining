...
static double degree7[5] = { +0.5, -0.10843500, +0.00102394287, -0.00000518229,
		+0.00000000934 };  //|wTx| < 16
////////////////////////////////  For Full-Batch NAG  //////////////////////////////
...
static double degree7_12[5] = { +0.5, -2.3514e-01, +1.2329e-02, -3.9345e-04,
		+4.7292e-06 };  // 1 - poly(-yWTx)
...
static double degree7_24[5] = { +0.5, -0.15512, +0.0028088, -0.000026158,
		+0.000000085324 };
// z = -6.3921e-07.*x.^7 + 1.1023e-04.*x.^5 -6.6579e-03.*x.^3 + 2.0683e-01.*x.^1 + 5.0000e-01; |x| < 9
...
static double degree7_36[5] = { +0.5, -0.11634, +0.0011850, -0.0000062074,
		+0.000000011389 };
////////////////////////////////  For Mini-Batch NAG  //////////////////////////////
...
public:
	...
	static void dataFromFile(string &path, long &factorDim, long &sampleDim,
			double **&X, int *&Y);
	static void zDataFromFile(string &path, long &factorDim, long &sampleDim,
			double **&X, int *&Y);
	static int classnum(int *Y, long sampleDim);
	static void oneHotEncoding(int *&labels, long sampleDim, int **&label1hot);
	static void printData(int **zData, long factorDim, long sampleDim);
	static void printData(double **zData, long factorDim, long sampleDim);
	static void printData(complex<double> *zData, long factorDim,
			long sampleDim);
